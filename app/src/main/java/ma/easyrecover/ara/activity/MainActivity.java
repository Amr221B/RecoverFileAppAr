...
import ma.easyrecover.ara.BuildConfig;
import ma.easyrecover.ara.Constant;
import ma.easyrecover.ara.R;
import ma.easyrecover.ara.share.DisplayMetricsHandler;
import ma.easyrecover.ara.share.MainApplication;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void shareApp() {
        ...
        try {
            ...
            shareIntent.putExtra(Intent.EXTRA_SUBJECT, "استعادة الملفات المحذوفة");
            String shareMessage = "استعادة الملفات المحذوفة" + "\n\nاسمح لي أن ارشح لك هذا التطبيق\n\n";
            ...
            shareapp.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try {
                        ...
                        String shareMessage = "استعادة الملفات المحذوفة" + "\n\nاسمح لي ان ارشح لك هذا التطبيق\n\n";
                        shareMessage = shareMessage + "https://play.google.com/store/apps/details?id=" + BuildConfig.APPLICATION_ID + "\n\n";
                        shareIntent.putExtra(Intent.EXTRA_TEXT, shareMessage);
                        startActivity(Intent.createChooser(shareIntent, "choose one"));
                        dialog.dismiss();
